...
async fn handle_research() -> impl IntoResponse {
    ...
    let trends = serde_json::json!([
        {
            ...
            "take": "polymarket 95% probability that devs vibe-code an entire saas in 20 mins with claude then spend 4 days struggling to record a 60s demo video. stop recording manually.",
            "type": "Polymarket"
        },
        {
            "topic": "Polymarket: AI Agent Wrappers in YC Batches",
            "volume": "High Heat",
            "sentiment": "Contrarian / Tech Sarcasm",
            "take": "polymarket 92% chance the next YC batch is 80% wrapper agents and 20% founders complaining about cloud GPU bills.",
            "type": "Polymarket"
        },
        {
        ...
        {
            "topic": "Pure AI: Frontier Reasoning vs Regex",
            "volume": "Viral Tech Debate",
            "sentiment": "Sarcastic Developer Reality",
            "take": "spending $20M training a frontier reasoning model just for people to use it to write cover letters and generate regex.",
            "type": "Pure AI Tech"
        },
        {
            "topic": "Pure AI: Prompt Engineering Reality",
            "volume": "High Engagement",
            "sentiment": "Developer Humor",
            "take": "90% of prompt engineering is just asking the model 'are you sure' until it gaslights itself into changing its answer.",
            "type": "Pure AI Tech"
        },
        {
            "topic": "Pure AI: Vibe Coding Schema Chaos",
            "volume": "Viral / High Heat",
            "sentiment": "Relatable Tech Discourse",
            "take": "vibe coding has turned software engineering into high-stakes prompt poetry. 1 typo and your supabase schema is in the shadow realm.",
            "type": "Pure AI Tech"
        },
        {
            "topic": "Pure Tech: PR Review Reality",
            "volume": "Relatable Pain",
            "sentiment": "Developer Sarcasm",
            "take": "the best code is no code. the second best code is code generated by claude that you pretend you understand in the pr review.",
            "type": "Pure AI Tech"
        }
    ]);

    let ai_tech_takes = serde_json::json!([
    ...
    let rage_bait_takes = serde_json::json!([
